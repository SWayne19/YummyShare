...
<template>
    ...
    <Layout>
        <div class="space-y-24 pb-12">
            ...
            <section class="relative w-full bg-gray-900 py-24 overflow-hidden">
                    ...
                    <div
                        ...
                        <div class="space-y-8 relative z-10">
                            ...
                            <div class="pt-4 flex gap-4">
                                <a href="#"
                                    class="h-12 w-12 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-orange-500 transition-all">

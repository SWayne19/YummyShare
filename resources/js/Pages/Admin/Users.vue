    ...
    <AdminLayout>
        <div class="space-y-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-xl sm:text-2xl font-black text-gray-900 dark:text-white">Users</h1>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <th class="text-left px-4 sm:px-5 py-3 font-semibold text-gray-500 dark:text-gray-400">Name</th>
                                ...
                                <th class="text-right px-4 sm:px-5 py-3 font-semibold text-gray-500 dark:text-gray-400">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="user in users.data" :key="user.id"
                                ...
                                <td class="px-4 sm:px-5 py-3">
                                    <div class="flex items-center gap-3">
                                        <div class="h-7 w-7 rounded-full bg-orange-100 dark:bg-orange-900/50 flex items-center justify-center text-orange-600 dark:text-orange-400 font-bold text-xs flex-shrink-0">
        ...
        <transition enter-active-class="transition duration-200 ease-out" enter-from-class="opacity-0" enter-to-class="opacity-100"
            ...
            <div v-if="showModal" class="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50" @click.self="showModal = false">
                <div class="w-full max-w-md rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-2xl p-5 sm:p-6 space-y-5"
                    @click.stop>
                    <h2 class="text-lg font-bold text-gray-900 dark:text-white">{{ editingUser ? 'Edit User' : 'Create User' }}</h2>

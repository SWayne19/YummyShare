    ...
    <Layout>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 space-y-8">
            ...
            <section class="relative z-20">
                <div
                    class="bg-white dark:bg-gray-900/80 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)] border border-gray-100/80 dark:border-gray-800 p-3 sm:p-4 md:p-6 transition-all duration-300">
                    ...
                    <div class="relative flex items-center w-full mb-4">
                        ...
                        <input v-model="search" type="text" placeholder="Search by recipe, ingredient, or chef..."
                            class="block w-full pl-12 pr-4 py-3 bg-gray-50/50 dark:bg-white/5 border border-gray-200 dark:border-gray-700 rounded-2xl text-gray-900 dark:text-white focus:bg-white dark:focus:bg-white/10 focus:ring-4 focus:ring-orange-500/15 focus:border-orange-500 transition-all duration-300 text-sm sm:text-base placeholder:text-gray-400 dark:placeholder:text-gray-500 placeholder:font-medium" />
                    </div>
                        ...
                        <div class="relative group sm:col-span-2 md:col-span-1">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <input v-model="maxTime" type="number" min="1" placeholder="Max minutes (e.g. 30)"
                                    class="block w-full pl-11 pr-4 py-2.5 bg-gray-50/50 dark:bg-white/5 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:bg-white dark:focus:bg-white/10 focus:outline-none focus:ring-4 focus:ring-orange-500/15 focus:border-orange-500 transition-all font-medium placeholder:text-gray-400 dark:placeholder:text-gray-500" />
                            </div>
                        </div>
            ...
            <section class="relative z-10 pt-4">
                ...
                <div v-if="visibleRecipes.length === 0"
                    ...
                    <div
                        class="mb-5 flex h-12 w-12 items-center justify-center rounded-full bg-orange-50 dark:bg-orange-950/50 text-orange-500 shadow-inner">
                    ...
                    <Link v-for="(recipe, index) in visibleRecipes" :key="recipe.id" :href="`/recipes/${recipe.id}`"
                        ...
                        <div class="absolute inset-0 flex flex-col justify-end p-4 sm:p-5 md:p-7">
                            <div class="transform transition-all duration-500 translate-y-4 group-hover:translate-y-0">
                                ...
                                <h3
                                    class="text-xl sm:text-2xl md:text-3xl font-black text-white mb-3 sm:mb-4 leading-tight drop-shadow-md line-clamp-2">
                                    {{ recipe.title }}
                                </h3>
                                ...
                                <div class="flex items-center justify-between border-t border-white/20 pt-3 sm:pt-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="h-7 w-7 sm:h-8 sm:w-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white border border-white/30 font-bold text-sm sm:text-lg">
                                    ...
                                    <div
                                        class="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-white text-gray-900 flex items-center justify-center shadow-lg transform transition-transform duration-300 group-hover:rotate-45 group-hover:bg-orange-500 group-hover:text-white">

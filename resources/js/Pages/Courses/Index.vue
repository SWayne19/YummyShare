<template>
    <Layout>
            ...
            <div class="mx-auto max-w-6xl py-6">
                ...
                <div class="mb-4 flex flex-wrap items-center justify-center gap-3">
                    <div class="relative w-full sm:w-72">
                        <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-slate-300/80"
                            aria-hidden="true">
                    ...
                    <div class="relative w-full sm:w-40">
                        <select v-model="status"
                            ...
                            <option value="inactive" class="bg-black text-white">
                                Inactive
                            </option>
                        </select>
                ...
                <div
                    ...
                    <div
                        ...
                        <button v-if="search || status || courseType" @click="resetFilters" type="button"
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-white/10">
                                <tr v-for="course in courses" :key="course.id" class="group hover:bg-white/5">
        ...
        <div v-if="statusModalOpen"
            class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div class="bg-white rounded-lg shadow-xl p-7 w-[95vw] max-w-sm text-slate-800 relative">
                <button class="absolute right-3 top-2 text-slate-400 hover:text-slate-900 text-xl cursor-pointer"
                ...
                <div class="mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-2 h-10 w-10 text-indigo-500" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-center text-slate-700">
                        ...
                        the course
                        <span class="font-semibold">"{{ selectedCourseName }}"</span>?
                    </div>
                </div>
                <div class="flex gap-2 justify-end mt-4">
                    ...
                    <button @click="confirmStatusChange" :disabled="form.processing"
        ...
        <div v-if="deleteModalOpen"
            class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div class="bg-white rounded-lg shadow-xl p-7 w-[95vw] max-w-sm text-slate-800 relative">
                <button class="absolute right-3 top-2 text-slate-400 hover:text-slate-900 text-xl"
                ...
                <div class="mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-2 h-10 w-10 text-red-600" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-center text-slate-700">
                        ...
                        <span class="font-semibold">"{{ deleteCourseName }}"</span>? This action cannot be undone.
                    </div>
                </div>
                <div class="flex gap-2 justify-end mt-4">
